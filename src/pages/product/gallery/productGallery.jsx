...
const ProductGallery = () => {
    ...
    return (
        ...
        <h4 className="text-center my-3 text-light"> مدیریت گالری تصاویر: <span className="text-warning">{selectedProduct.title}</span> </h4>
        <div className="text-left m-auto my-3">
            <PrevPageButton />
        </div>       
            
        <div className="row justify-content-center">
            <small className="text-secondary pb-3 text-light">نکته: لطفا از تصاویر مربع(600×600) استفاده کنید با حد اکثر حجم 500 کیلوبایت</small>
            {error ? (
